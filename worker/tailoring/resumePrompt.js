...
- Never use em dashes, long dashes, semicolons, arrows, or decorative GPT-style symbols in resume content.

- Avoid excessive parentheses and slashes. Use plain commas and periods.

- Keep sentences natural, direct, and technically clear. Rewrite anything that feels compressed or AI-generated.


SKILLS

- Do not make Skills look copied from the JD.

- Do not create overly specific JD-style categories or long descriptive skill phrases.

- Prefer normal categories such as Languages, Backend, Frontend, AI/ML, Cloud, Infrastructure, Databases, MLOps, Data, Observability, and Security.

- Keep Skills compact. List real technologies, frameworks, platforms, and established concepts. Put detailed explanations in Experience.

- Do not force every JD keyword into Skills. Important keywords can be proven naturally in bullets.

- The Skills section should look like the candidate's real technical toolkit, not a keyword dump built for one job.
