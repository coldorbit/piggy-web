...
export function getMarketplaceParticipantModel() {
  ...
  MarketplaceParticipant = getSequelize().define(
    'MarketplaceParticipant',
    {
      ...
      participantRole: { type: DataTypes.TEXT, allowNull: false, defaultValue: 'both', field: 'participant_role' },
      ...
      riskStatus: { type: DataTypes.TEXT, allowNull: false, defaultValue: 'normal', field: 'risk_status' },
      publicNotes: { type: DataTypes.TEXT, field: 'public_notes' },
    ...
    },
    {
      ...
      createdAt: 'createdAt',
      updatedAt: 'updatedAt',
      indexes: [{ unique: true, fields: ['user_id'] }, { fields: ['review_status'] }, { fields: ['participant_role'] }],
    },
  );
