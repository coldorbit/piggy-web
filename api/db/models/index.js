...
export { getInterviewCallModel } from './interviewCall.js';
export { getInterviewModel } from './interview.js';
export { getJobBidModel } from './jobBid.js';
export { getJobProfileScoreModel } from './jobProfileScore.js';
export { getLearningArticleModel } from './learningArticle.js';
export { getLearningCompanyModel } from './learningCompany.js';
...
export { getProfileLearningReviewModel } from './profileLearningReview.js';
export { getProfilePrepPlanModel } from './profilePrepPlan.js';
export { getProfileStoryModel } from './profileStory.js';
export { getRankingImpressionModel } from './rankingImpression.js';
...
import { getInterviewCallModel } from './interviewCall.js';
import { getInterviewModel } from './interview.js';
import { getJobBidModel } from './jobBid.js';
import { getJobProfileScoreModel } from './jobProfileScore.js';
import { getLearningArticleModel } from './learningArticle.js';
import { getLearningCompanyModel } from './learningCompany.js';
...
import { getProfileLearningReviewModel } from './profileLearningReview.js';
import { getProfilePrepPlanModel } from './profilePrepPlan.js';
import { getProfileStoryModel } from './profileStory.js';
import { getRankingImpressionModel } from './rankingImpression.js';
...
export function setupWebAssociations() {
  ...
  const InterviewCallModel = getInterviewCallModel();
  const InterviewModel = getInterviewModel();
  const JobBidModel = getJobBidModel();
  const JobProfileScoreModel = getJobProfileScoreModel();
  const LearningArticleModel = getLearningArticleModel();
  const LearningCompanyModel = getLearningCompanyModel();
  ...
  const ProfileLearningReviewModel = getProfileLearningReviewModel();
  const ProfilePrepPlanModel = getProfilePrepPlanModel();
  const ProfileStoryModel = getProfileStoryModel();
  const RankingImpressionModel = getRankingImpressionModel();
  ...
  WebUserModel.hasMany(LearningArticleModel, { foreignKey: 'createdByUserId', as: 'learningArticles' });
  LearningArticleModel.belongsTo(WebUserModel, { foreignKey: 'createdByUserId', as: 'createdBy' });
  WebUserModel.hasMany(LearningCompanyModel, { foreignKey: 'createdByUserId', as: 'learningCompanies' });
  LearningCompanyModel.belongsTo(WebUserModel, { foreignKey: 'createdByUserId', as: 'createdBy' });
  LearningCompanyModel.hasMany(LearningArticleModel, { foreignKey: 'companyId', as: 'articles' });
  LearningArticleModel.belongsTo(LearningCompanyModel, { foreignKey: 'companyId', as: 'company' });
  ...
  InterviewModel.hasMany(InterviewCallModel, { foreignKey: 'interviewId', as: 'calls' });
  InterviewCallModel.belongsTo(InterviewModel, { foreignKey: 'interviewId', as: 'interview' });
  ...
  BidProfileModel.hasMany(ProfileLearningReviewModel, { foreignKey: 'profileId', as: 'learningReviews', onDelete: 'CASCADE' });
  ProfileLearningReviewModel.belongsTo(BidProfileModel, { foreignKey: 'profileId', as: 'profile' });
  JobBidModel.hasOne(ProfileLearningReviewModel, { foreignKey: 'jobBidId', as: 'learningReview', onDelete: 'CASCADE' });
  ProfileLearningReviewModel.belongsTo(JobBidModel, { foreignKey: 'jobBidId', as: 'jobBid' });
  InterviewModel.hasOne(ProfileLearningReviewModel, { foreignKey: 'interviewId', as: 'learningReview', onDelete: 'CASCADE' });
  ProfileLearningReviewModel.belongsTo(InterviewModel, { foreignKey: 'interviewId', as: 'interview' });
  WebUserModel.hasMany(ProfileLearningReviewModel, { foreignKey: 'updatedByUserId', as: 'updatedProfileLearningReviews' });
  ProfileLearningReviewModel.belongsTo(WebUserModel, { foreignKey: 'updatedByUserId', as: 'updatedBy' });
  ...
  BidProfileModel.hasMany(JobProfileScoreModel, { foreignKey: 'profileId', as: 'jobScores', onDelete: 'CASCADE' });
  JobProfileScoreModel.belongsTo(BidProfileModel, { foreignKey: 'profileId', as: 'profile' });
  ScrapedJobModel.hasMany(JobProfileScoreModel, { foreignKey: 'jobId', as: 'profileScores', onDelete: 'CASCADE' });
  JobProfileScoreModel.belongsTo(ScrapedJobModel, { foreignKey: 'jobId', as: 'job' });
  WebUserModel.hasMany(RankingImpressionModel, { foreignKey: 'userId', as: 'rankingImpressions' });
  RankingImpressionModel.belongsTo(WebUserModel, { foreignKey: 'userId', as: 'user' });
  BidProfileModel.hasMany(RankingImpressionModel, { foreignKey: 'profileId', as: 'rankingImpressions', onDelete: 'CASCADE' });
  RankingImpressionModel.belongsTo(BidProfileModel, { foreignKey: 'profileId', as: 'profile' });
  ScrapedJobModel.hasMany(RankingImpressionModel, { foreignKey: 'jobId', as: 'rankingImpressions', onDelete: 'CASCADE' });
  RankingImpressionModel.belongsTo(ScrapedJobModel, { foreignKey: 'jobId', as: 'job' });
